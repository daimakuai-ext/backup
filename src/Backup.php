...
class Backup extends Extension
{
    ...
    protected static function registerRoutes()
    {
        parent::routes(function ($router) {
            ...
            $router->get('backup', 'Jblv\Admin\Backup\BackupController@index')->name('backup-list');
            $router->get('backup/download', 'Jblv\Admin\Backup\BackupController@download')->name('backup-download');
            $router->post('backup/run', 'Jblv\Admin\Backup\BackupController@run')->name('backup-run');
            $router->delete('backup/delete', 'Jblv\Admin\Backup\BackupController@delete')->name('backup-delete');
        });
    }
